    ...
    public class RepositoryTests
    {
        ...
        public async void GetAll_ShouldReturnAListOfCategory_WhenCategoriesExist()
        {
            await using (var context = new BookStoreDbContext(_options))
            {
                ...
                Assert.IsType<List<Genre>>(categories);
            }
        }
        ...
        public async void AddCategory_ShouldAddCategoryWithCorrectValues_WhenCategoryIsValid()
        {
            ...
            await using (var context = new BookStoreDbContext(_options))
            {
                ...
                Assert.IsType<Genre>(categoryToAdd);
        ...
        {
            Genre categoryToUpdate = new Genre();
            await using (var context = new BookStoreDbContext(_options))
            {
            ...
            await using (var context = new BookStoreDbContext(_options))
            {
                ...
                Assert.IsType<Genre>(updatedCategory);
        ...
        {
            Genre categoryToRemove = new Genre();
        ...
        private List<Genre> CreateCategoryList()
        {
            ...
            {
                new Genre { Id = 1, Name = "Category Test 1" },
                new Genre { Id = 2, Name = "Category Test 2" },
                new Genre { Id = 3, Name = "Category Test 3" }
            };
        }
...
internal class RepositoryConcreteClass : Repository<Genre>
{
