...
namespace BookStore.Infrastructure.Tests
{
    public static class BookStoreHelperTests
    {
        ...
        {
            bookStoreDbContext.Categories.Add(new Genre { Id = 1, Name = "Category Test 1" });
            bookStoreDbContext.Categories.Add(new Genre { Id = 2, Name = "Category Test 2" });
            bookStoreDbContext.Categories.Add(new Genre { Id = 3, Name = "Category Test 3" });
            bookStoreDbContext.Books.Add(new Movie()
            {
                Id = 1,
                Name = "Book Test 1",
